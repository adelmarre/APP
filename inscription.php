...
if (isset($_POST['suivant']))
{
  ...
  $mail = ($_POST['mail']);
  $numero = ($_POST['numero']);
  $motdepasse = crypt($_POST['motdepasse'],'st');
  $motdepasse2 = crypt($_POST['motdepasse2'],'st');
  $mdpS = password_hash($motdepasse,PASSWORD_DEFAULT);
                  ...
                  if ($mailexist==0) 
                  {
                    ...
                    for ($i=1;$i<$longueurKey;$i++){
                      ...
                      if (isset($_POST['choix']))
                      {
                        ...
                        $successInsertMBR = $insertmbr->execute(array($nom, $prenom, $mail, $mdpS, $numero, $key));
