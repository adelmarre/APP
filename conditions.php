...
<body>
    ...
    <h1>Conditions générales d'utilisation</h1><form method="POST" action="">
  <div>
    Article 1 : Objet
  </div>
 <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site Hexagon et leur utilisation par « l'Utilisateur ».</br>
...
<li>Identifiant et mot de passe : c'est l'ensemble des informations nécessaires à l'identification d'un Utilisateur sur le site. L'identifiant et le mot de passe permettent à l'Utilisateur d'accéder à des services réservés aux membres du site. Le mot de passe est confidentiel.</li></ul></p>
  <div>Article 4 : Définitions</div>
  <p> Le site est accessible à tout Utilisateur ayant un accès à Internet et ayant un forfait chez Domisep (voire offres Domisep pour plus d'informations). Les frais supportés par l'Utilisateur pour accéder au service (matériel informatique, logiciels, connexion Internet, etc.) sont à sa charge.</br>

  Selon le cas :</br>

  L’Utilisateur non membre n'a pas accès aux services réservés aux membres. Pour cela, il doit s'identifier à l'aide de son identifiant et de son mot de passe et un forfait domotique chez Domisep. </br>
  ...
  Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur sera signalé.</br>
...
Tout contenu mis en ligne par l'Utilisateur est de sa seule responsabilité. L'Utilisateur s'engage à ne pas mettre en ligne de contenus pouvant porter atteinte aux intérêts de tierces personnes. Tout recours en justice engagé par un tiers lésé contre le site sera pris en charge par l'Utilisateur. </p>
<div>Article 6 : Données personnelles</div>
<p>
 Les informations demandées à l’inscription au site sont nécessaires et obligatoires pour la création du compte de l'Utilisateur. 
...
<div>ARTICLE 8 : Liens hypertextes</div>
<p> Les liens hypertexte mèneront vers des sites gérés par Domisep.</p>
<div>ARTICLE 9 : Evolution du contrat </div>

<p>Le site se réserve à tout moment le droit de modifier les clauses stipulées dans le présent contrat. L'utilisateur sera prévenue dans ce cas et devra accepter de nouvelles conditions d'utilisation.</p>
