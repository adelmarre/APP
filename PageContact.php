		...
		<div id="bloc_page">
			<div id="conteneur">
				<div id="section1">
					...
					<a href="chat.php?idd=1&amp;ide=<?=$userinfo['id']?>&amp;id=<?=$userinfo['id']?>">Accéder à mon chat</a><p><?php if ($pasvuexist == 0) {echo"";} else {echo "Vous avez $pasvuexist nouveau(x) message(s)";} ?></p></br></br> 
				<?php } else { ?>
				</div>
			</div>
				<div id="section2">
					<div id="aside21">
					<p>Pour nous contacter, merci de bien vouloir remplir le champs ci-dessous. Notre équipe s'engage à vous répondre dans les plus brefs délais</p>
					</div>
